...
export const metadata: Metadata = {
  title: {
    default: 'Aumento de Seguidores – Crecimiento Real y Seguro',
  ...
  generator: 'Next.js',
  applicationName: 'Aumento de Seguidores – Crecimiento Real y Seguro',
  ...
  publisher: 'Aumento de Seguidores – Crecimiento Real y Seguro',
  ...
  openGraph: {
    ...
    title: 'Aumento de Seguidores – Crecimiento Real y Seguro',
    description:
      'Aumenta tus seguidores en redes sociales con herramientas seguras y efectivas. Instagram, TikTok, Facebook y más.',
    siteName: 'Aumento de Seguidores – Crecimiento Real y Seguro',
    images: [
      {
        url: '/favicon.ico',
        width: 1200,
