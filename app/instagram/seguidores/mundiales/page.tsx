...
const instagramServices: Service[] = [
  {
    id: "followers-1000",
    name: "1000 Seguidores Mundiales",
    quantity: 1000,
    price: 5.00,
    icon: UserPlus,
    description: "Seguidores Mundiales para Instagram",
    deliveryTime: "1 hora - 24 horas",
    image: "/1000s.png",
    features: [
      "Seguidores mundiales",
      "Entrega garantizada",
      "Soporte 24/7",
  ...
  {
    id: "followers-10000",
    name: "10000 Seguidores Mundiales",
    quantity: 10000,
    price: 48.00,
    icon: UserPlus,
    description: "Seguidores mundiales para Instagram",
  ...
  {
    id: "followers-5000",
    name: "5000 Seguidores Mundiales",
    quantity: 5000,
    price: 22.00,
    icon: UserPlus,
    description: "Seguidores mundiales para Instagram",
        ...
        <section className="py-5 bg-[oklch(0.145_0_0)] text-white">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-purple-gradient mb-6">
              Servicios de Instagram Mundiales
            </h1>
            <p className="text-xl text-white max-w-2xl mx-auto mb-8">
              Aumenta tu presencia en Instagram con seguidores, likes, comentarios y más.
