...
const instagramServices: Service[] = [
  {
    id: "comentarios-1000",
    name: "1000 Comentarios Bots",
    quantity: 1000,
    price: 5.00,
    icon: MessageCircle,
    description: "Comentarios bots para Instagram",
  ...
  {
    id: "comentarios-10000",
    name: "10000 Comentarios Bots",
    quantity: 10000,
    price: 45.00,
    icon: MessageCircle,
    description: "Comentarios bots para Instagram",
        ...
        <section className="py-5 bg-[oklch(0.145_0_0)] text-white">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-purple-gradient mb-6">
              Servicios de Comentarios Bots
            </h1>
            <p className="text-xl text-white max-w-2xl mx-auto mb-8">
              Aumenta tu engagement en Instagram con comentarios bots de calidad.
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {instagramServices.map((service) => (
                <Card
                  ...
                  ${service.id === "comentarios-10000" ? "border-purple-500 border-2" : ""}`}
                >
                  <CardHeader>
